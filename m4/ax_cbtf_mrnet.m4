...
AC_DEFUN([AX_CBTF_MRNET], [
    ...
    CPPFLAGS="$CPPFLAGS $CBTF_CPPFLAGS $CBTF_XML_CPPFLAGS $CBTF_MRNET_CPPFLAGS $MRNET_CPPFLAGS $BOOST_CPPFLAGS"
    LDFLAGS="$CXXFLAGS $CBTF_LDFLAGS $CBTF_XML_LDFLAGS $MRNET_LDFLAGS $LIBXERCES_C_LDFLAGS $CBTF_MRNET_LDFLAGS $BOOST_LDFLAGS"
    LIBS="$CBTF_LIBS $CBTF_XML_LIBS $CBTF_MRNET_LIBS $MRNET_LIBS $LIBXERCES_C $BOOST_FILESYSTEM_LIB $BOOST_THREAD_LIB $BOOST_SYSTEM_LIB"
